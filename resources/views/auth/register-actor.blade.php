...
<x-landing-layout title="Login">
    <section class="wrapper bg-light !bg-[#ffffff] pt-28">
        <div class="container !pb-[4.5rem] pt-20 md:pt-36 xl:!pb-24 lg:!pb-24 md:!pb-24">
                    ...
                    <div class="!shadow-none card">
                        <div class="card-body p-0 md:!p-12 !text-center w-full">
                            <h2 class="mb-3 text-left">
                                Register as Voice Actor
                            </h2>
                            <p class="lead text-[0.9rem] font-medium !leading-[1.65] !mb-6 text-left">
                                Before we can add you as a voice over, we need some information and demos.
                            </p>
                            <form class="text-left !mb-3 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8"
                                ...
                                @method('POST') @csrf
                                <input type="hidden" name="role" value="voice_actor">
                                <div>
                                ...
                                <div class="grid gap-4 md:col-span-2 md:gap-8 md:grid-cols-2">
                                ...
                                <div class="form-select-wrapper">
                                    <select class="form-select" id="form-select" name="gender" required>
                                ...
                                <div class="form-select-wrapper">
                                    <select class="form-select" name="language_code" required>
                                        ...
                                        <option {{ $language->code == $request->old('language_code', 'en') ?
                                            'selected' : '' }} value="{{
                                ...
                                <div class="border-b divide-y md:col-span-2 border-b-gray-300"></div>

                                <div class="grid gap-4 md:grid-cols-2 md:gap-8 md:col-span-2">
                                    <div class="col-span-1 form-floating !relative">
